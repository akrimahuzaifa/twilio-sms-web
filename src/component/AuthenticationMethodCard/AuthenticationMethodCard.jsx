    ...
    <div className="min-h-screen w-full flex items-center justify-center">
      ...
      <div className="relative w-full max-w-[800px] text-center p-8 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 place-items-center">
          <div
            className={`bg-white border border-gray-200 rounded-[1.25rem] p-8 flex flex-col items-center text-center max-w-[360px] w-full transform transition-all duration-700 ease-out shadow-md hover:shadow-xl hover:-translate-y-2 hover:border-[#3b82f6] ${
